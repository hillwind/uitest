...
var processArgs = function(argv, options) {
  ...
  if (argv.version) {
    console.log('uitest version: ' + constant.VERSION);
    process.exit(0);
  }
  ...
  options.configFile = path.resolve( __dirname,'../uitest.conf.js');
...
var describeShared = function() {
  optimist
    .usage('uitest - Spectacular Test Runner for web ui.\n\n' +
           'Usage:\n' +
           '  $0 <command>\n\n' +
           'Commands:\n' +
