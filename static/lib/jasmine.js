(function () {
    ...
    jasmine.getEnv = function () {
        if (jasmine._newEnv) {
            jasmine._newEnv = false;
            var env = jasmine.currentEnv_ = new jasmine.Env();

            for (var i = 0; i < jasmine._beforeEach.length; i++) {

                env.beforeEach(jasmine._beforeEach[i])
            }
            for (var i = 0; i < jasmine._afterEach.length; i++) {

                env._afterEach(jasmine._afterEach[i])
            }
        }
        else {
 ...
 * });
    ...
    var beforeEach = function (beforeEachFunction) {
        jasmine._beforeEach.push(beforeEachFunction);
    ...
    var afterEach = function (afterEachFunction) {
        jasmine._afterEach.push(beforeEachFunction);
...
// Provide the XMLHttpRequest class for IE 5.x-6.x:
    ...
    jasmine.Env = function () {
        ...
        this.currentQueue = new jasmine.Queue(this);
        this.allReports = [];
...
//else for IE support
    ...
    jasmine.PrettyPrinter.prototype.format = function (value) {
        ...
        try {
            ...
            } else if (typeof value.nodeType === 'number' || value.jquery) {
    ...
    jasmine.Spec.prototype.execute = function (onComplete) {
        ...
        var onc = function () {
            ...
            onComplete.apply(spec, arguments)
        }
    ...
    jasmine.WaitsForBlock.TIMEOUT_INCREMENT = 5;
    ...
    jasmine.WaitsForMatchers.prototype.execute = function (onComplete) {
        ...
        try {
            ...
            if (this.messageArray.length == 0) {
                ...
                for (var i = 0; i < this.messageArray.length; i++) {
                    if (!this.messageArray[i].passed_) {
                        tempResult = false;
                        break;
                    }
                }
        ...
        if (latchFunctionResult) {
            ...
            for (var i = 0; i < this.messageArray.length; i++) {
                ...
                this.spec.addMatcherResult(this.messageArray[i]);
            }
            onComplete();
        } else if (this.totalTimeSpentWaitingForLatch >= this.timeout) {
